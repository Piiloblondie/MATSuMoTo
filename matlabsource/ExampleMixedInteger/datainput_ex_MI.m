...
%DATAINPUT_EX_MI is an optimization test problem with continuous AND 
%integer variables; the problem is adoptd from
%http://www.aridolan.com/ga/gaa/MultiVarMin.html
%--------------------------------------------------------------------------
